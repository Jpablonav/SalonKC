...
@section('contenido')
    <div class="container">
        <h1>Editar</h1>
        <form  class="needs-validation" novalidate method="POST" action="/empleados/{{$empleado->empleadoid}}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="form-row">
                ...
                <div class="col-md-6 mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" id="validationServer153"
                        placeholder="Ejemplo: Ana" name="nombre" required value="{{$empleado->nombre}}">
                    <div class="valid-feedback">
                        Nombre Válido!
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" id="validationServer163"
                        placeholder="Ejemplo: Peluquero" name="especialidad" required value="{{$empleado->especialidad}}">
                    <div class="valid-feedback">
                        Especialidad Válida!
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3 mt-3">
                    ...
                    <input type="tel" class="form-control" id="validationServer173"
                        placeholder="Ejemplo: 3316708413" name="telefono" required value="{{$empleado->telefono}}">
                    <div class="valid-feedback">
                        Teléfono Válido!
                    </div>
                    <div class="invalid-feedback">
