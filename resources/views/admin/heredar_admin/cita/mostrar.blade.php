    ...
    <form class="needs-validation" novalidate method="POST" action="/citas/{{ $cita->cita_id}}"> 
        ...
        <div class="form-row">
            ...
            <div class="col-md-6 mb-3 mt-3">
                ...
                <input type="number" class="form-control" id="validationServer063"
                    placeholder="Ejemplo: 1" name="empleado_id" required readonly value="{{ $cita->empleado_id}}">
                <div class="valid-feedback">
                    Empleado ID Válido!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="col-md-6 mb-3 mt-3">
                ...
                <input type="date" class="form-control" id="validationServer073"
                    placeholder="Seleccione una fecha" name="fecha" required readonly value="{{ $cita->fecha}}">
                <div class="valid-feedback">
                    Fecha Válida!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="col-md-6 mb-3 mt-3">
                ...
                <input type="time" class="form-control " id="validationServer083"
                    placeholder="Seleccione una hora" name="hora" required readonly value="{{ $cita->hora}}">
                <div class="valid-feedback">
                    Hora Válida!
                </div>
                <div class="invalid-feedback">
