...
<div>
<h1>Borrar</h1>
<form class="needs-validation" novalidate method="POST" action="/proovedor/{{$proovedor->id}}" enctype="multipart/form-data">
    @csrf
    @method('DELETE')
    <div class="form-row">
        <div class="col-md-12 mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="validationServer103"
                placeholder="Ejemplo: Marca XYZ" name="marca" required readonly value="{{$proovedor->marca}}">
        ...
        <div class="col-md-12 mb-3 mt-3">
            ...
            <input type="text" class="form-control" id="validationServer113"
                placeholder="Ejemplo: Juan" name="nombre" required readonly value="{{$proovedor->nombre}}">
            <div class="valid-feedback">
                Nombre Válido!
            </div>
            <div class="invalid-feedback">
        ...
        <div class="col-md-6 mb-3 mt-3">
            ...
            <input type="tel" class="form-control" id="validationServer123"
                placeholder="Ejemplo: 3316708413" name="telefono" required readonly value="{{$proovedor->telefono}}">
            <div class="valid-feedback">
                Teléfono Válido!
            </div>
            <div class="invalid-feedback">
        ...
        <div class="col-md-6 mb-3 mt-3">
            ...
            <div class="input-group">
                <input type="email" class="form-control" id="validationServer133"
                    placeholder="Ejemplo: correo@ejemplo.com" name="email" required readonly value="{{$proovedor->email}}">
        ...
        <div class="col-md-6 mb-3 mt-3">
            ...
            <img src="/storage/{{$proovedor->imagen}}" alt="{{$proovedor->imagen}}" width="100px">
