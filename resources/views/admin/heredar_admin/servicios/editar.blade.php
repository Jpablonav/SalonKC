            ...
            <div class="form-row">
                ...
                <div class="col-md-6 mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" id="validationServer293"
                        placeholder="Ejemplo: Corte de Cabello" name="nombre_servicio" required value="{{$servicio->nombre_servicio}}">
                    <div class="valid-feedback">
                ...
                <div class="col-md-6 mb-3 mt-3">
                    ...
                    <input type="text" class="form-control" id="validationServer313"
                        placeholder="Ejemplo: 1 hora" name="duracion" required value="{{$servicio->duracion}}">
                    <div class="valid-feedback">
                        Duración Válida!
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3 mt-3">
                    ...
                    <input type="number" class="form-control" id="validationServer323"
                        placeholder="Ejemplo: 30.00" name="precio" required value="{{$servicio->precio}}">
                    <div class="valid-feedback">
                        Precio Válido!
                    </div>
                    <div class="invalid-feedback">
                ...
                <div class="col-md-6 mb-3 mt-3">
                    <label for="validationServer333">Nombre del producto Producto</label>
                    <select class="form-select" aria-label="Productos" name="producto_id" required>
                        <option></option>
                        @foreach ($productos as $producto)
                            <option {{$producto->producto_id==$producto->producto_id?'selected':''}} value="{{ $producto->nombre_producto }}">{{ $producto->nombre_producto }}</option>
                        @endforeach
