...
<div class="container">
    <h1>Editar</h1>
    <form class="needs-validation" novalidate method="POST" action="/usuarios/{{ $users->id }}" enctype="multipart/form-data">
        @csrf
        @method('DELETE')
        <div class="form-row">
            <div class="col-md-6 mb-3 mt-3">
                ...
                <input type="number" class="form-control" id="validationServer093" placeholder="Ejemplo: 1"
                    name="id" readonly value="{{ $users->id }}">
            ...
            <div class="col-md-6 mb-3 mt-3">
                ...
                <input type="text" class="form-control" id="validationServer353"
                    placeholder="Ejemplo: Juan" name="name" required value="{{ $users->name}}">
                <div class="valid-feedback">
                    Nombre Válido!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="col-md-6 mb-3 mt-3">
                ...
                <input type="email" class="form-control" id="validationServer373"
                    placeholder="Ejemplo: usuario@example.com" name="email" required value="{{ $users->email}}">
                <div class="valid-feedback">
                    Email Válido!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="col-md-6 mb-3 mt-3">
                ...
                <input type="password" class="form-control" id="validationServer393" placeholder="********"
                    name="password" required value="{{ $users->passwrod}}">
                <div class="valid-feedback">
                    Contraseña Válida!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="col-md-6 mb-3 mt-3">
                ...
                <input type="text" class="form-control" id="validationServer403"
                    placeholder="Ejemplo: Admin o Base" name="rol" required value="{{ $users->rol}}">
                <div class="valid-feedback">
            ...
            <div class="col-md-6 mb-3 mt-3">
                ...
                <input type="text" class="form-control" id="validationServer403"
                    placeholder="Ejemplo: Active o Inactive" name="status" required value="{{ $users->status}}">
                <div class="valid-feedback">
                    Tipo de Status!
                </div>
                <div class="invalid-feedback">
            ...
            <div class="col-md-6 mb-3 mt-3">
                ...
                <input type="text" class="form-control" id="validationServer403"
                    placeholder="Ejemplo: 3344718492" name="telefono" required value="{{ $users->telefono}}">
                <div class="valid-feedback">
                    Telefono Válido!
                </div>
                <div class="invalid-feedback">
